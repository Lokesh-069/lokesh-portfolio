...
export function Intro({ onStart, onSkipGame }: { onStart: () => void; onSkipGame: () => void }) {
  ...
  useEffect(() => {
    const tips = [
      ...
      "Space to jump, double tap to fly",
      "Collect wood to craft tools",
      "Dig down to find valuable ores",
      "Watch out for creepers at night",
      "Build a shelter before dark",
      "Food restores your health",
      "Water flows downward and spreads",
      "Redstone can create complex circuits",
      "Diamonds are found deep underground",
      "Lava lights up the area",
      "Sleep in a bed to set your spawn",
      "Enchant gear for better abilities",
      "Breed animals with their favorite food",
      "Fishing can yield rare treasures",
      "Explore strongholds for End portals",
      "Trade with villagers for emeralds",
      "Potions grant special abilities",
      "The Nether is accessible via portals",
      "Endermen teleport when looked at"
    ];
    ...
    <div className="fixed inset-0 z-40 overflow-hidden bg-background">
      ...
      <AnimatePresence mode="wait">
        {phase === "loading" && (
          ...
          >
            <div className="font-pixel text-xs text-primary animate-blink">LOADING WORLD…</div>
